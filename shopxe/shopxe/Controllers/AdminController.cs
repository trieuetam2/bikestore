...
namespace shopxe.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            double slkh = _context.AspNetUsers.Count();
            return slkh;
        }
        ...
        public async Task<IActionResult> DeleteUser(string? id)
        {
            ...
            var sanPham = await _context.AspNetUsers
                .Include(s => s.Id)
        ...
        {
            var sanPham = await _context.AspNetUsers.FindAsync(id);
            _context.AspNetUsers.Remove(sanPham);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
